-- CreateEnum
CREATE TYPE "UPDATE_STATUS" AS ENUM ('IN_PROGRESS', 'DEPRECATED', 'ARCHIVED');
...
-- AddForeignKey
ALTER TABLE "Update" ADD CONSTRAINT "Update_producId_fkey" FOREIGN KEY ("producId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
